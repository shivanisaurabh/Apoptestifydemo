...
public class ScreenshotUtility implements ITestListener {
	...
	//This method will execute only when the test is pass.
		public void onTestSuccess(ITestResult tr) {
			...
			if(WebBaseclass.prop.getProperty("screenShotOnPass").equalsIgnoreCase("yes"))
			{
		...
		public void onTestFailure(ITestResult tr) {		
			...
			if(WebBaseclass.prop.getProperty("screenShotOnFail").equalsIgnoreCase("yes"))
			{
		...
		public static  void captureScreenShot(ITestResult result, String status){	
			...
			File scrFile = ((TakesScreenshot)base.WebBaseclass.drivers).getScreenshotAs(OutputType.FILE);
